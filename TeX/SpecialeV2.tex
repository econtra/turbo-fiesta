...
\begin{figure}[H]
	%\includegraphics[width=\textwidth]{accountsOLD}
...
\begin{example}[A simple savings contract]
...
\begin{figure}[H]
%	\includegraphics[width=\textwidth]{pensionBenefitOLD}
