...
%\titel{Prognoses and Sensitivities}
%\undertitel{} 
...
\title{XX} %Slet denne og indkommenter ovenstående 
...
Assume a contract paying out the lump sum $\triangle B_0$ if the policy holder is active at the time of retirement $R$. If the she is disabled at retirement, she receives no benefit. Premium $\pi$ is paid as active until retirement. In other words, the payment stream is
...
\begin{figure}[H]
	...
	\includegraphics[width=\textwidth]{LumpSumNyAgeAtRetirement} \label{LumpFigure}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=\textwidth]{TermNy} \label{Term}
\end{figure}
