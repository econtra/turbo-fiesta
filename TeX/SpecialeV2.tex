...
\newglossary[slg]{symbolslist}{syi}{syg}{Notation overview} 
\makeglossaries
...
\begin{align*}
	f_j^{1yy}(t) =& r(t) - \delta_2^y(t) - b_y^{D_1}(t) \\
	f_j^{1yx}(t) =& \left( r(t) - r^*(t) \right) - \delta_2^x(t) - b_x^{D_1}(t) \\
	&+ \frac{1}{V_j^{\circ *}(t)} \left( \sum_{k \in \mathcal{J} \atop k \neq j} \rho_{jk}^\dagger(t) + \sum_{k \in \mathcal{J} \atop k \neq j} R_{jk}^{\dagger*}(t) \mu_{jk}(t) \right) \\
